...
export const it = {
  ...
  individualPositionsAsset: 'Posizioni Individuali - Asset',
  ...
  riskScoreFormula: 'Formula: (Σ(% allocazione × peso rischio) ÷ Σ(% allocazione)) × 2',
  ...
  riskScoreBasedOnMPT: 'Basato sul Modern Portfolio Theory e sulla volatilità degli asset. Calcolo ponderato e normalizzato:',
  ...
  emergencyFundWithIcon: '🛡️ Fondo di emergenza',
  ...
  individualPositionsLabel: 'Posizioni Individuali',
  ...
  csvTemplateHeaders: 'Nome,Ticker,ISIN,Tipo Transazione,Quantità,Importo,Commissioni,Data',
  csvTemplateExample: 'Apple Inc.,AAPL,US0378331005,Acquisto,10,1500.00,5.00,2024-01-15',
