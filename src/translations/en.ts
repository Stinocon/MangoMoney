...
export const en = {
  ...
  individualPositionsAsset: 'Individual Positions - Assets',
  ...
  riskScoreFormula: 'Formula: (Σ(% allocation × risk weight) ÷ Σ(% allocation)) × 2',
  ...
  riskScoreBasedOnMPT: 'Based on Modern Portfolio Theory and asset volatility. Weighted and normalized calculation:',
  ...
  emergencyFundWithIcon: '🛡️ Emergency Fund',
  ...
  individualPositionsLabel: 'Individual Positions',
  ...
  csvTemplateHeaders: 'Name,Ticker,ISIN,Transaction Type,Quantity,Amount,Fees,Date',
  csvTemplateExample: 'Apple Inc.,AAPL,US0378331005,Purchase,10,1500.00,5.00,2024-01-15',
